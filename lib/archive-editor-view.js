    ...
    return (
      <div className='archive-editor' tabIndex='-1'>
        <div className='archive-container'>
          ...
          <div ref='errorMessage' className='padded icon icon-alert text-error'></div>
          <div className='inset-panel'>
            <div ref='summary' className='panel-heading'></div>
            <ol ref='tree' className='archive-tree padded list-tree has-collapsable-children'></ol>
          </div>
        </div>
      </div>
    )
